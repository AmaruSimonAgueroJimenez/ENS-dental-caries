...
The updated author package includes a Spanish explanatory addendum. The proposal's current numerical results, five composite figures, three main tables and twelve supplementary tables remain unchanged. Water remains visible as a secondary predictor without an established independent predictive gain or causal interpretation.
